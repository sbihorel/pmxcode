...
The covariate module of `pmxcode` supports the bulk creation of univariate models for execution of stepwise covariate analysis in NONMEM. It is akin to the `scm` tool from [Perl-speaks-NONMEM](file:///home/sebastien/Downloads/scm_userguide.pdf), but defers in several ways: 
